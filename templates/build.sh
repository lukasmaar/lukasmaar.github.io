  ...
  while IFS='=' read -r key value; do
    ...
    awk '
      ...
      END {
        ...
        print "COUNT_TALKS_2026=" (count["TALKS_2026"] + 0)
        ...
        print "COUNT_AWARDS_2026=" (awards_count["2026"] + 0)
...
apply_counts() {
  ...
  perl -0777 -i -pe '
    ...
    s/\{\{COUNT_TALKS_2026\}\}/$ENV{COUNT_TALKS_2026}/g;
    ...
    s/\{\{COUNT_AWARDS_2026\}\}/$ENV{COUNT_AWARDS_2026}/g;
